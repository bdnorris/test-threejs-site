    ...
    <div class="home-view__content">
      <div class="home-view__sections">
        <section 
          ...
          :class="[
            'home-view__section',
            `home-view__section--${index + 1}`,
            { 'home-view__section--left': index % 2 === 0 },
            { 'home-view__section--right': index % 2 === 1 }
          ]"
          :ref="el => sectionRefs[index] = el"
        >
          <div class="home-view__section-content">
            <h2 class="home-view__section-title">{{ section.title }}</h2>
            <p class="home-view__section-text">{{ section.text }}</p>
          </div>
        </section>
      </div>
      
      <div 
        class="home-view__canvas-container"
        :class="{
          'home-view__canvas-container--left': currentSide === 'left',
          'home-view__canvas-container--right': currentSide === 'right'
        }"
      >
        <ThreeJSCanvas 
          ref="threeCanvasRef"
          class="home-view__canvas"
        />
      </div>
    </div>
  </div>
